# Generated by Django 4.2.13 on 2024-06-05 13:21
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_id', models.ForeignKey(db_column='product_id', null=True, on_delete=django.db.models.deletion.SET_NULL, to='database.product', verbose_name='Product')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tr', models.CharField(max_length=14, null=True, unique=True, verbose_name='TR')),
